...
class EditRoomViewModel extends ContextViewModel
    with
  ...
  EditRoomViewModel(Room room)
      : _room = room,
        _selectedFloor = room.floorId,
        _selectedRoomType = room.roomTypeId,
        number = TextEditingController(text: room.number);
