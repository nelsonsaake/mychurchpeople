...
import 'create_room_type_viewmodel.dart';

class CreateRoomTypeView extends StackedView<CreateRoomTypeViewModel> {
  const CreateRoomTypeView({super.key});
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            const ViewTitle("Create Room Type"),
  ...
  @override
  CreateRoomTypeViewModel viewModelBuilder(BuildContext context) {
    return CreateRoomTypeViewModel();
  }

  @override
  void onViewModelReady(CreateRoomTypeViewModel viewModel) {
    viewModel.init();
